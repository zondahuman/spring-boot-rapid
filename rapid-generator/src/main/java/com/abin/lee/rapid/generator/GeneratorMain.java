package com.abin.lee.rapid.generator;
...
//		################################################################################################################################
		...
		// g.printAllTableNames(); // 打印数据库中的表名称
		// g.deleteOutRootDir(); //删除生成器的输出目录
//		generatorFacade.getGenerator().addTemplateRootDir("./rapid-generator/template");
		generatorFacade.getGenerator().addTemplateRootDir("./rapid-generator/plugins");
